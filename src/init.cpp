    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  silkcoin [options]                     " + "\n" +
                  "  silkcoin [options] <command> [params]  " + _("Send command to -server or silkcoin") + "\n" +
                  "  silkcoin [options] help                " + _("List commands") + "\n" +
                  "  silkcoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: silkcoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single silkcoin process is using the data directory.
    ...
    // requested to kill silkcoin-qt during the last operation. If so, exit.
